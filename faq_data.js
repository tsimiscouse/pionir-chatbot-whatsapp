module.exports = [
  // 1. Inisiasi perkenalan
  {
    ...
    answer: "Halo GAMADA! 🎉 Perkenalkan aku Pio-Bot, chatbot PIONIR Gadjah Mada yang siap membantu kamu. Boleh kah Pio-Bot tahu namamu?"
  },

  // 2. Mengenal nama pengguna
  {
    regex: /^(?:nama\s+saya|namaku|nama\s+aku|nama\s+gw)\s+([a-zA-Z\s]+)/i,
    answer: "Senang bertemu denganmu, $1! 👋 Semoga kamu bisa menjadi bagian dari Gadjah Mada Muda yang gemilang. Ada kah yang bisa Pio-Bot bantu?",
    hasCaptureGroup: true
  },

  {
    regex: /\b(ingin\s+bertanya|bertanya\s+tentang|tanya\s+terkait|ada\s+pertanyaan|mau\s+tanya|tanya)\b/i,
    answer: "Baik, silakan sampaikan pertanyaanmu terkait *PIONIR UGM* ataupun *Informasi Umum UGM*. Pio-Bot siap membantu! 😊",
